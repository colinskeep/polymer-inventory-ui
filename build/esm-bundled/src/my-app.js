...
</custom-style>`;document.head.appendChild($_documentContainer$1.content);var style$1=document.createElement("style");style$1.textContent="[hidden] { display: none !important; }";document.head.appendChild(style$1);Polymer({_template:html`
    <style>
      :host {
        @apply --layout-inline;
...
</custom-style>`;document.head.appendChild($_documentContainer$3.content);const $_documentContainer$4=document.createElement("template");$_documentContainer$4.setAttribute("style","display: none;");$_documentContainer$4.innerHTML=`<dom-module id="paper-icon-button">
...
</dom-module>`;document.head.appendChild($_documentContainer$4.content);Polymer({is:"paper-icon-button",hostAttributes:{role:"button",tabindex:"0"},behaviors:[PaperInkyFocusBehavior],properties:{src:{type:String},icon:{type:String},alt:{type:String,observer:"_altChanged"}},_altChanged:function(newValue,oldValue){var label=this.getAttribute("aria-label");if(!label||oldValue==label){this.setAttribute("aria-label",newValue)}}});const $_documentContainer$5=document.createElement("template");$_documentContainer$5.setAttribute("style","display: none;");$_documentContainer$5.innerHTML=`<custom-style>
  <style is="custom-style">
    html {
...
</dom-module>`;document.head.appendChild($_documentContainer$7.content);Polymer({is:"paper-spinner",behaviors:[PaperSpinnerBehavior]});const $_documentContainer$8=document.createElement("template");$_documentContainer$8.innerHTML=`<iron-iconset-svg name="my-icons" size="24">
  <svg>
    <defs>
      <g id="arrow-back">
      ...
      <app-drawer-layout fullbleed="" narrow="{{narrow}}">
        ...
        <app-drawer id="drawer" slot="drawer" swipe-open="[[narrow]]">
          <app-toolbar><img src="https://pbs.twimg.com/profile_images/553637105981599744/LL6I25EV.jpeg" class="logo"></app-toolbar>
          <iron-selector selected="[[page]]" attr-for-selected="name" class="drawer-list" role="navigation">
            <a name="view1" href="[[rootPath]]view1">Inventory By Location</a>
            <a name="view2" href="[[rootPath]]view2">Dashboard</a>
            <a name="view3" href="[[rootPath]]view3">Assign Item to Location</a>
            <a name="view4" href="[[rootPath]]view4">Assign UPC Code to Item</a>
          </iron-selector>
        </app-drawer>
